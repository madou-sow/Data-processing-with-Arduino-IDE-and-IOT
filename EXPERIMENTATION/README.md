...
<img alt="Console bash" src="https://github.com/madou-sow/Data-processing-with-Arduino-IDE-and-IOT/blob/main/images/generdata.png" width=70% height=70%  title="Console bash"/>

###### **Figure 1 : In a terminal you have to run the program to generate**

<img alt="Arduino IDE serial monitor" src="https://github.com/madou-sow/Data-processing-with-Arduino-IDE-and-IOT/blob/main/images/arduinoreceivmessag.png" width=60% height=60%  title="Arduino IDE serial monitor"/>
